...
// follow the id to find the course
...
router.post("/", async (req, res) => {
    // validate the inputs before makeing a new course
...
router.delete("/:_id", async (req, res) => {
    ...
    if (req.user.isAdmin() || course.instructor.equals(req.user._id)) {
